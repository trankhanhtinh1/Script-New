...
inline constexpr std::array<MobilityRule, 50> MobilityRules = {
    ...
    MobilityRule{ SDK::ChampionId::Ambessa, SDK::SpellSlot::E },
    ...
    MobilityRule{ SDK::ChampionId::Elise, SDK::SpellSlot::Q },
    MobilityRule{ SDK::ChampionId::Evelynn, SDK::SpellSlot::R },
    ...
    MobilityRule{ SDK::ChampionId::Rengar, SDK::SpellSlot::Q },
...
inline constexpr ChampionController Controller = [] {
    ...
    controller.ChampionId = SDK::ChampionId::Taliyah;
