...
inline constexpr std::array<MobilityRule, 28> EscapeRules = {
    ...
    MobilityRule{ SDK::ChampionId::Caitlyn, SDK::SpellSlot::E },
    ...
    MobilityRule{ SDK::ChampionId::Zoe, SDK::SpellSlot::R },
    MobilityRule{ SDK::ChampionId::Smolder, SDK::SpellSlot::E },
};
...
inline constexpr ChampionController Controller = [] {
    ...
    controller.ChampionId = SDK::ChampionId::Azir;
