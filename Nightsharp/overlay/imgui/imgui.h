...
typedef int ImGuiKey;               // -> enum ImGuiKey_             // Enum: A key identifier (ImGuiKey_XXX or ImGuiMod_XXX value)
typedef int ImGuiMouseSource;       // -> enum ImGuiMouseSource_     // Enum; A mouse input source identifier (Mouse, TouchScreen, Pen)
