...
namespace MenuUI {
    ...
    public:
        ...
        std::vector<std::pair<std::string, std::string>> GetRootSections() const {
            ...
            std::vector<std::shared_ptr<MenuItem>> standaloneItems;
    ...
    private:
        bool SplitRootItems(std::vector<std::shared_ptr<MenuItem>>& standaloneItems,
            ...
            for (auto& item : standaloneItems) {
                if (!dynamic_cast<MenuKeyBind*>(item.get())) {
                    onlyKeyBinds = false;
                    break;
                }
            }
        ...
        void DrawRootSectionContent(const std::string& sectionKey,
                                    const std::vector<std::shared_ptr<MenuItem>>& standaloneItems,
