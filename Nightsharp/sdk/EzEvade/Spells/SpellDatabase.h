...
namespace EzEvade {
    inline std::vector<SpellData>& GetSpellDatabase() {
        ...
        Spells.push_back([](){
            ...
            d.spellType = SpellType::Line;
            d.collisionObjects = { CollisionObjectType::EnemyChampions, CollisionObjectType::EnemyMinions };
            d.fixedRange = true;
            return d;
        }());
        ...
        Spells.push_back([](){
            ...
            d.extraMissileNames = { "ViktorEAugMissile", };
            d.spellType = SpellType::Line;
            d.usePackets = true;
            d.fixedRange = true;
            return d;
        ...
        Spells.push_back([](){
            ...
            d.extraSpellNames = { "KarthusLayWasteA2", "KarthusLayWasteA3", "KarthusLayWasteD1", "KarthusLayWasteD2", "KarthusLayWasteD3" };
            d.spellType = SpellType::Circular;
            return d;
        }());
        ...
        Spells.push_back([](){
            ...
            d.projectileSpeed = 1500; // Actually variable based on movement speed, but baseline
            d.radius = 300;
            d.range = 1000;
            d.spellDelay = 250.0f;
            d.spellKey = SpellSlot::R;
        ...
        Spells.push_back([](){
            ...
            d.dangerlevel = 3;
            d.name = "Aqua Prison";
            d.projectileSpeed = 2500; // Actually fixed travel time 875ms, approx 250+ time
            d.radius = 200;
            d.range = 875;
            d.spellDelay = 875.0f; 
            d.spellKey = SpellSlot::Q;
        ...
        Spells.push_back([](){
            ...
            d.spellType = SpellType::Circular; // technically line of movement and circular dest
            d.isSpecial = true;
            return d;
        }());
        ...
        Spells.push_back([](){
            ...
            d.spellName = "SionR";
            d.spellType = SpellType::Line;
            d.fixedRange = true; // Technically follows path, but usually treated as line
            return d;
        }());
    ...
    inline const SpellData* GetSpellByMissile(const std::string& missileName) {
        for (auto& s : GetSpellDatabase()) {
            if (!s.missileName.empty() && detail::EqualsIgnoreCase(s.missileName, missileName))
                return &s;
            if (!s.missileSpellName.empty() && detail::EqualsIgnoreCase(s.missileSpellName, missileName))
                return &s;
