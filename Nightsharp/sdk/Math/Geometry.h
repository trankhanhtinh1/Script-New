...
#include "Polygons/ArcPoly.h"
#include "Polygons/CirclePoly.h"
#include "Polygons/LinePoly.h"
#include "Polygons/Polygon.h"
#include "Polygons/RectanglePoly.h"
#include "Polygons/RingPoly.h"
...
inline Vec3 PositionAlongPath(const std::vector<Vec3>& path, float distance) {
    return PositionOnPath(path, distance);
}
