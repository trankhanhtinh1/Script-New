...
namespace CoreSkinChanger {
    ...
    inline bool PackmanWrite(uintptr_t addr, const T& value) {
        static_assert(std::is_trivially_copyable_v<T>,
                      "CoreSkinChanger::PackmanWrite requires trivially copyable values");
    ...
    inline bool WriteEncryptedSkinId(uintptr_t hero, int skinId) {
        ...
        __try {
            ...
            return PackmanWrite<LeagueObfuscation<int>>(fieldAddr, block);
        }
        __except (1) {
            return false;
        }
