...
//
//   Source: League of Legends unknown
//   SHA-256: 9715ef5b9112877227c1239d04dafed9d9f5ef6fe7d75e2d83a7c0a57fc19111
//
...
namespace GameObjectsRuntime {
    constexpr auto Player = 0x1F304B0; //48 8B 05 ? ? ? ? 4C 8B DA 4C 8B C1
    constexpr auto TeamTable = 0x1EF0D08; //48 8B 05 ? ? ? ? 8B 54 88 ? 48 8D 05
    constexpr auto Objects = 0x1EF0D28;//48 8B 3D ? ? ? ? ? ? ? 80 7B ? 00
    constexpr auto Heroes = 0x1EF0E48; //48 8B 05 ? ? ? ? 45 33 FF 49 89 73
    constexpr auto Minions = 0x1EF0E88; //48 8B 0D ? ? ? ? E8 ? ? ? ? 33 FF 48 85 C0
    constexpr auto Missiles = 0x1EF42B0; //4C 8B 35 ? ? ? ? 8B 9E || 48 8B 0D ? ? ? ? 48 89 75 || 48 8B 0D ? ? ? ? F3 0F 10 5D
    constexpr auto Turrets = 0x1EFA390; //48 8B 2D ? ? ? ? 85 D2 || 48 89 0D ? ? ? ? 83 78 || 48 8B 2D ? ? ? ? 49 8B D8
    constexpr auto UnderMouseObject = 0x1EF44B8; //48 8B 0D ? ? ? ? 88 44 24 ? 48 8B 45 || 48 8B 05 ? ? ? ? 48 8B F9 33 C9 48 8B DA
} // namespace GameObjectsRuntime
...
namespace StructureVTable {
    ...
    namespace ObjectManagerRuntime {
        ...
        constexpr auto GetFirstObject = 0xA6D1F0; //E8 ? ? ? ? 48 6B D3 || E8 ? ? ? ? 48 8B C8 48 85 C0 74 ? ? ? ? 8B 49 || E8 ? ? ? ? 48 83 BB ? ? ? ? 00 ? ? ? 8B A9
        constexpr auto GetNextObject = 0x574CD0; //E8 ? ? ? ? 48 8B D8 48 85 C0 0F 85 ? ? ? ? 0F 28 || E8 ? ? ? ? 48 8B ? 48 85 C0 0F 85 ? ? ? ? 44 0F
        constexpr auto FindObject = 0x573A10; //E8 ? ? ? ? 0F 28 D6 48 8B D7 || E8 ? ? ? ? 48 85 C0 75 ? 84 DB || E8 ? ? ? ? 48 85 C0 74 ? 41 B0 40 8B D3
    } // namespace ObjectManagerRuntime

namespace GameRuntime {
    constexpr auto GameTime = 0x1F00698; //F3 0F 5C 35 ? ? ? ? 0F 28 F8 || F3 0F 11 3D ? ? ? ? 48 8B 49
    constexpr auto NetInstance = 0x1EF0D20; //48 8B 05 ? ? ? ? 48 8B F2 48 8B D9 48 85 C0 || 48 8B 05 ? ? ? ? 0F B6 15 ? ? ? ? 48 85 C0 41 0F 95 C1
    constexpr auto MissionInfoInstance = 0x1EF0E38; //48 8B 0D ? ? ? ? E8 ? ? ? ? 48 8D 8F ? ? ? ? 89 47 ||48 8B 0D ? ? ? ? 48 8B 1D ? ? ? ? E8 ? ? ? ? 8B D0
    constexpr auto ChatViewController = 0x1F03418; //48 8B 0D ? ? ? ? 0F B6 D8 48 85 C9 || 48 8B 05 ? ? ? ? 48 85 C0 74 ? 88 90
    constexpr auto ShopInstance = 0x1F03420; //48 8B 0D ? ? ? ? E8 ? ? ? ? 84 C0 74 ? 0F B6 87 || 48 8B 0D ? ? ? ? 48 85 C9 74 ? E8 ? ? ? ? 84 C0 0F 85 ? ? ? ? 48 85 DB
    constexpr auto OpenWindowsArray = 0x1FCEF48; //48 8B 3D ? ? ? ? 33 ED || 48 8B 05 ? ? ? ? 48 8B 4C C8 || 48 8B 05 ? ? ? ? 48 39 5C C8
    constexpr auto OpenWindowsCount = 0x1FCEF50; //89 35 ? ? ? ? 48 8B F9 || 8B 05 ? ? ? ? 4C 8B 4B || 89 15 ? ? ? ? ? ? ? 48 8B CB
    // Legacy/unused: runtime spell readiness uses ControlRuntime::GetSpellState.
    constexpr auto MySpellState = 0x1F1D078; // 48 89 05 ? ? ? ? 48 8D 05 ? ? ? ? ? ? ? 48 8D 05 ? ? ? ? ? ? ? E8 ? ? ? ? 48 8D 8F ? ? ? ? 48 89 AF ? ? ? ? 48 89 AF ? ? ? ? E8 ? ? ? ? 48 8D 35 ? ? ? ? 48 89 AF ? ? ? ? 48 8D 8F ? ? ? ? 48 89 B7 ? ? ? ? 48 89 AF ? ? ? ? E8 ? ? ? ? 48 8D 8F ? ? ? ? 48 89 AF ? ? ? ? 48 89 AF ? ? ? ? 48 89 B7 ? ? ? ? E8 ? ? ? ? 48 89 AF
    ...
    constexpr auto CursorPosRaw = 0x1F91A40; //F2 0F 10 05 ? ? ? ? F2 41 0F 11 40 ? 8B 05 ? ? ? ? 0F 10 44 24 || 48 8D 0D ? ? ? ? E8 ? ? ? ? 48 89 84 24 ? ? ? ? 4C 8B D0
    ...
    constexpr auto MouseScreenVec2 = 0x1EF4260; //48 8B 0D ? ? ? ? 4C 8D 45 ? 48 8D 55 ? C7 45 ? 00 00 00 00 || 48 83 3D ? ? ? ? 00 0F 84 ? ? ? ? 8B 47
    constexpr auto GetPing = 0x6CF9B0; //E8 ? ? ? ? 8B F0 39 43 || E8 ? ? ? ? 8B C0 0F 57 C9 || E8 ? ? ? ? 44 0F B6 53 ? 4C 8D 05
    constexpr auto GetMapID = 0x289500; //E8 ? ? ? ? 44 8B CB 48 8D 57 || E8 ? ? ? ? 8B D0 48 8D 4C 24 || E8 ? ? ? ? 83 F8 ? 75 ? C6 86
    ...
    constexpr auto PrintChat = 0xB7B960; //E8 ? ? ? ? 4C 8B C3 B2 || E8 ? ? ? ? 4C 8B C3 33 D2 48 8B CE || E8 ? ? ? ? E9 ? ? ? ? 4C 8B 15
    ...
    constexpr auto ChatMessageInstance = 0x1EF4508; //48 8B 1D ? ? ? ? 24 || 4C 8B 25 ? ? ? ? 75 || 48 8B 3D ? ? ? ? 48 8D 4C 24 ? 8B 1D
...
namespace DrawingRuntime {
    constexpr auto WorldToScreen = 0x13350F0; //E8 ? ? ? ? 84 C0 75 ? F3 0F 10 97 || E8 ? ? ? ? F3 0F 10 5D ? 48 8D 45 || E8 ? ? ? ? 84 C0 75 ? 48 85 FF 75
    ...
    constexpr auto ViewProjectionRoot = 0x1EF4258; //4C 8B 2D ? ? ? ? 48 89 55 || 48 8B 0D ? ? ? ? 0F 57 C0 48 8B || 48 8B 0D ? ? ? ? 4C 8B 84 24
    ...
    constexpr auto HudRoot = 0x1EF0EB0; //48 8B 0D ? ? ? ? 48 85 C9 75 ? 8B C5 || 48 8B 0D ? ? ? ? 48 85 C9 75 ? 33 C0
    constexpr auto HudInstance = 0x1EF0EB8; //48 8B 1D ? ? ? ? 41 8B 55 || 48 8B 0D ? ? ? ? 44 0F B6 EB || 48 8B 0D ? ? ? ? 8B 57 ? 48 8B 49
    ...
    constexpr auto ViewPort = 0x1F03380; //48 8B 0D ? ? ? ? 0F 28 D1 48 8B 5C 24 || 48 8B 1D ? ? ? ? 48 8B 49 ? E8 ? ? ? ? 0F 28 D0 48 8D 55
    constexpr auto ViewPort2 = 0x1FD0A20; //48 89 1D ? ? ? ? EB ? 48 8B D8 || 48 C7 05 ? ? ? ? 00 00 00 00 48 8D 4B
    constexpr auto Renderer = 0x1FD0A48; //48 89 35 ? ? ? ? 48 8B 8E || 4C 8B 3D ? ? ? ? 41 83 46 || 48 89 1D ? ? ? ? 48 8B 8F
    constexpr auto ViewProjOffset = 0x1FBA090; //48 8D 0D ? ? ? ? 66 0F 7F 45 || 48 8D 0D ? ? ? ? ? ? ? 0F 11 84 24 || 48 8D 0D ? ? ? ? C7 45 ? 00 00 00 00 E8
    ...
    constexpr auto StatsManager = 0x1EF0EF0; //4C 8B 0D ? ? ? ? 8B 83 || 48 8B 1D ? ? ? ? 48 8D B0 || 48 8B 1D ? ? ? ? 48 8B CE FF 50
} // namespace DrawingRuntime
...
namespace HudRuntime {
    ...
    constexpr auto SpellTargeting = 0x68; //48 8B 58 68 0F B6 42 10 0F B6 D0 D0 E8 80 E2 D5
    ...
    constexpr auto CameraZoomLimits = 0x3A8; //48 8B 81 ? ? ? ? F3 0F 10 40 ? EB ? F3 0F 10 05 ? ? ? ? 0F 2F C8 77 ? 48 8B 81 ? ? ? ? F3 0F 10 40 ? F3 0F 5F C1 0F 2E 81 ? ? ? ? 7A ? 74 ? F3 0F 11 81 ? ? ? ? B0
    constexpr auto AltZoomLimits = 0x470; //48 8B 83 ? ? ? ? F3 0F 10 1D
    constexpr auto ZoomLockFlag1 = 0x3DC; //0F B6 91 ? ? ? ? F3 0F 10 89
    constexpr auto ZoomLockFlag2 = 0x3DD; //80 B9 ? ? ? ? 00 88 81 ? ? ? ? 75 ? 84 D2 74
...
namespace HudCursorTargetLogicRuntime {
    constexpr auto ShowClickEffect = 0xBD7D30; // native cursor click effect dispatcher
} // namespace HudCursorTargetLogicRuntime
...
namespace HudSpellTargetingLayout {
    ...
    constexpr auto TargetChampionsOnly = 0x3C; //F3 0F 10 41 3C 48 8B CE F3 0F 11 44 24 70
} // namespace HudSpellTargetingLayout
...
namespace ChatViewControllerLayout {
    constexpr auto InputPanel  = 0x370; //48 8D 8D ? ? ? ? B8 ? ? ? ? 41 B8
    constexpr auto InputActive = 0x5D8; //48 8D A9 ? ? ? ? 48 89 70
    constexpr auto Ready       = 0x671; //88 90 ? ? ? ? C3
    constexpr auto PrimaryOpen = 0x672; //80 BB ? ? ? ? 00 75 ? 48 8B CB C6 83 ? ? ? ? ? E8
    constexpr auto InputMode   = 0x673; //80 B9 ? ? ? ? 00 48 8D 44 24 ? 48 8B 35
...
namespace ControlRuntime {
    constexpr auto IssueOrder = 0x2962A0; //E8 ? ? ? ? 33 D2 C7 05 || E8 ? ? ? ? 83 FB ? 0F 44 FD || E8 ? ? ? ? 8D 43 ? 89 05 ? ? ? ? 0F B6 BD
    ...
    constexpr auto UpdateChargeableSpell = 0x99FF10; //E8 ? ? ? ? 48 8B 46 ? F3 0F 10 35 || E8 ? ? ? ? 45 33 ED BB ? ? ? ? 4C 89 6F || E8 ? ? ? ? 48 C7 47 ? 00 00 00 00 F3 0F 10 05
    ...
    constexpr auto UpdateChargeAim = 0x9A0620; // E8 ? ? ? ? 48 8B 0D ? ? ? ? 48 8B 49 ? E8 ? ? ? ? F3 0F 58 05 ? ? ? ? F3 0F 11 86 || 40 53 48 83 EC ? B8 ? ? ? ? 48 C7 44 24 ? 00 00 00 00
    ...
    constexpr auto CastSpellSafe          = 0xBD9750; // programmatic CastSpell dispatcher E8 ? ? ? ? EB ? 80 7F ? 00 74 || E8 ? ? ? ? 33 C0 C7 43 ? ? ? ? ? 48 89 43 ? 38 43
    constexpr auto SendSpellCastPacket    = 0x97A070; // HUD SendSpellCastPacket (== Hooks::OnProcessSpell) E8 ? ? ? ? 85 C0 40 0F 94 C7 85 C0 || E8 ? ? ? ? 4C 8B 83 ? ? ? ? 8B F0
    constexpr auto BuildCastPacket        = 0x993B20; // build cast-spell packet payload E8 ? ? ? ? 48 8B 1D ? ? ? ? 48 8B D0 48 8B 48 ? 48 89 4C 24 || 48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC ? 48 8B CA 41 0F B6 F1
    constexpr auto SendNetworkPacket      = 0x6F1BB0; // send packet via NetInstance E8 ? ? ? ? 48 8B 45 ? 48 8B B8 || E8 ? ? ? ? 48 8B 5C 24 ? C6 47 ? 00
    constexpr auto InitChargeChanneling   = 0xBC4C40; // server ack/timer helper; not charge begin E8 ? ? ? ? 49 8D 4D ? E8 ? ? ? ? 48 8B D8 || 40 53 48 83 EC ? 48 8B D9 48 85 D2 74 ? 48 8B 41
    constexpr auto InitChargeState        = 0xBDAA50; // stores SpellInput at HudSpellState+0x38 E8 ? ? ? ? 48 39 77 ? 75 ? 4C 89 6F || E8 ? ? ? ? F3 0F 11 77 ? 48 8B 74 24
    constexpr auto ReleaseActiveCharge    = 0xBB88D0; // resolves slot and sends release E8 ? ? ? ? E9 ? ? ? ? 44 3B FB
    constexpr auto GetPlayerClient        = 0x2871D0; // charge sender uses return value + SpellBookOffset E8 ? ? ? ? 48 3B F0 75 ? 48 8B 05 
    ...
    constexpr auto FindOwnerSlot          = 0xBC2140; //E9 ? ? ? ? 48 8B 51 ? 48 85 D2 || E8 ? ? ? ? 4C 8B E0 48 85 C0 0F 84 ? ? ? ? 48 8B C8
    constexpr auto GetOwnerSlotIndex      = 0xBC2230; //E8 ? ? ? ? 33 FF 4C 8D 0D || E8 ? ? ? ? 49 8D 4F ? 8B E8
    constexpr auto NormalCastGate         = 0x307870; //E8 ? ? ? ? 84 C0 0F 84 ? ? ? ? 48 8B CE E8 ? ? ? ? 84 C0 74 || 83 FA ? 77 ? 48 63 C2 48 83 C0
    constexpr auto ServiceRegistryLookup  = 0x245200; //E8 ? ? ? ? 4D 8D 75 ? 48 8B F0 || E8 ? ? ? ? 48 85 C0 74 ? 41 8B 8E
    constexpr auto IsSlotQWER             = 0x403970; //E8 ? ? ? ? 84 C0 75 ? 8B CD || E8 ? ? ? ? 84 C0 0F 84 ? ? ? ? 8B 53
    constexpr auto PrepareCast            = 0x99B0C0; //E8 ? ? ? ? 8B D5 48 8B CE E8 ? ? ? ? E9 || E8 ? ? ? ? 49 8B 45 ? 49 8B CD FF 50 ? 48 8B D8
    constexpr auto ValidateProcessCast    = 0x320840; //E8 ? ? ? ? 0F B6 D0 88 86 || 48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC ? 49 8B C8 49 8B F9
    constexpr auto ExecuteNormalCast      = 0x3441C0; //E8 ? ? ? ? E9 ? ? ? ? 8B CD || 48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 57 48 83 EC ? 48 63 71
    constexpr auto ExecuteSelfCast        = 0x34CB00; //E8 ? ? ? ? E9 ? ? ? ? 48 8B 0D ? ? ? ? BA || 48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 57 48 83 EC ? 48 8B F1 48 63 FA
    constexpr auto ValidateTarget         = 0x31CEE0; //E8 ? ? ? ? 84 C0 74 ? 48 8B CF E8 ? ? ? ? 44 8B C8 || 48 83 EC ? 48 83 C2 ? E8 ? ? ? ? 48 85 C0
    constexpr auto RangeCheck             = 0x3247F0; //E8 ? ? ? ? 84 C0 74 ? 4C 8B C7 49 8B D4 || 48 83 EC ? 48 8B 49 ? ? ? ? FF 90 ? ? ? ? 85 C0
    constexpr auto ExecuteTargetCast      = 0x34C9D0; //E8 ? ? ? ? 8B 84 24 ? ? ? ? 49 8D 8F || 48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC ? 48 83 C2
    ...
    constexpr auto CanCastCheck           = 0xBEFFF0; //E8 ? ? ? ? 84 C0 74 ? 48 8B 53 ? 48 8B CB E8 || E8 ? ? ? ? 84 C0 0F 84 ? ? ? ? 48 8B D3 48 8B CF
    constexpr auto PrimeCastPosition      = 0xBC05C0; //E8 ? ? ? ? B0 ? EB ? 45 33 C0 || E8 ? ? ? ? 48 8B 57 ? 48 8D 4F ? 48 89 74 24
    ...
    constexpr auto HudSpellHandler        = 0xBC5210; //E8 ? ? ? ? B0 ? 48 83 C4 ? C3 44 8B C2 E8 || E8 ? ? ? ? ? ? ? 48 8B CE FF 90 ? ? ? ? 48 8B 5C 24
    ...
    constexpr auto CastSpellVector        = 0x99B990; //E8 ? ? ? ? 48 8B 5C 24 ? 48 8B 7C 24 ? 48 8B 74 24 || 48 8B C4 4C 89 48 ? 48 89 48 ? 55 53
    // GetSpellSlot(book, slot) == *(book + 0xAE0 + slot*8). sub_977B50.
    constexpr auto GetSpellSlot           = 0x995630; //E8 ? ? ? ? 48 8B C8 E8 ? ? ? ? 48 8B 4D || E8 ? ? ? ? 48 8B C8 E8 ? ? ? ? 41 80 7F ? 00
    ...
    constexpr auto CastVisionIndexDefault = 0x1F6AF00; //8B 05 ? ? ? ? 89 8E ? ? ? ? 48 8D 4E ? 89 86 || 8B 05 ? ? ? ? 89 8E ? ? ? ? 48 8D 4E ? 89 46
    constexpr auto SpellTypeClassify      = 0x8B9950; //E8 ? ? ? ? 3C ? 0F 87 ? ? ? ? B9 || E8 ? ? ? ? EB ? 48 8B 4F ? E8 ? ? ? ? 0F B6 C8
    constexpr auto GetSpellLevel          = 0x3B83A0; //E8 ? ? ? ? 48 8B 4D ? 44 8B E8 || E8 ? ? ? ? 41 80 7F ? 00 44 8B E8
    ...
    constexpr auto ProcessCastSpell = 0x29FC70; // 48 8D 05 ? ? ? ? 44 89 BD ? ? ? ? 48 89 85 ? ? ? ? 48 8D 8D ? ? ? ? 8B 44 24 ? 89 85 ? ? ? ? 48 8D 85 ? ? ? ? 48 89 85 ? ? ? ? E8 ? ? ? ? 4C 8B C8 48 8D 4B ? 41 B8 ? ? ? ? 48 8B D6 E8 ? ? ? ? 48 8D 8D ? ? ? ? E8 ? ? ? ? 48 8B 0D || 4C 8B DC 55 57 49 8D AB ? ? ? ? 48 81 EC ? ? ? ? 48 8B 05 ? ? ? ? 48 33 C4 48 89 85 ? ? ? ? 49 89 5B ? 49 89 73
    constexpr auto GetSpellState = 0x989A70; //E8 ? ? ? ? 41 8B 7F ? 8B D8 || E8 ? ? ? ? 85 C0 0F 94 C0 41 88 47
    ...
    constexpr auto GetSpellRemainingCooldown = 0x8B5A40; // E8 ? ? ? ? F3 0F 11 46 ? 40 0F B6 D7 || E8 ? ? ? ? 0F 28 F0 0F 2F 35 ? ? ? ? B8
    constexpr auto IsAlive = 0x2C01A0; //E8 ? ? ? ? 84 C0 74 ? 48 8B 83 ? ? ? ? 48 8D 8B || E8 ? ? ? ? 84 C0 74 ? 48 8D 8F ? ? ? ? E8 ? ? ? ? 84 C0 74 ? 48 85 DB
    constexpr auto GetSpellCastInfo = 0x2815D0; //E8 ? ? ? ? 8B 8E ? ? ? ? 8B D7 || E8 ? ? ? ? 8B 8B ? ? ? ? 48 8B F0 89 88
    constexpr auto GetResourceType = 0x27EF80; //E8 ? ? ? ? 33 D2 0F B6 C8 || E8 ? ? ? ? 3C ? 48 8B CF
    constexpr auto GetAttackDelay = 0x58D0A0; //E8 ? ? ? ? 33 C0 F3 0F 11 83 || E8 ? ? ? ? F3 0F 58 C6 44 38 B6
    constexpr auto GetAttackWindup = 0x58CFA0; //E8 ? ? ? ? 48 8B CF F3 0F 11 83 || E8 ? ? ? ? 48 8B CE F3 0F 11 83
    constexpr auto GetBoundingRadius = 0x282240; //E8 ? ? ? ? F3 44 0F 58 C0 || 40 53 48 83 EC ? ? ? ? 48 8B D9 FF 90 ? ? ? ? 48 85 C0 74 ? ? ? ? 48 8B CB FF 90 ? ? ? ? 48 8D 88
    constexpr auto IssueOrderFlag = 0x1E55E88; //89 05 ? ? ? ? 0F B6 BD || 89 05 ? ? ? ? 44 88 74 24
    constexpr auto CastSpellFlag = 0x1E55E20; //0F B6 05 ? ? ? ? 48 8D 57 ? 84 C0
    constexpr auto CanAttack = 0x2159A0; //E8 ? ? ? ? 84 C0 74 ? 49 8D 8F ? ? ? ? E8 ? ? ? ? 84 C0 74 ? 49 8D 8F ? ? ? ? E8 ? ? ? ? 84 C0 74 ? 49 8D 8F ? ? ? ? E8 ? ? ? ? 4D 8D A7
} // namespace ControlRuntime
...
namespace BuffDataLayout {
    ...
    constexpr auto BuffStacksAlt = 0x5C; //8B 47 ? 48 8D 5D ? 89 45 ? ? ? ? E8 ? ? ? ? ? ? 48 FF C3 48 8D 45 ? 48 3B D8 75 ? 8B 47 ? 48 8D 5D ? 89 45 ? ? ? ? E8 ? ? ? ? ? ? 48 FF C3 48 8D 45 ? 48 3B D8 75 ? 0F B6 4F ? E8 ? ? ? ? 8B 4F
...
namespace NavGridRuntime {
    constexpr auto NavGrid = 0x1EF41F8; //48 8B 05 ? ? ? ? 48 89 84 11 || 48 89 05 ? ? ? ? E8 ? ? ? ? 33 C9
    ...
    constexpr auto GetCollisionFlags = 0x12806B0; //E8 ? ? ? ? 84 C0 75 ? 48 8B 4D ? 48 85 C9 || E8 ? ? ? ? 84 C0 0F 85 ? ? ? ? 48 8B 4D ? 48 85 C9 0F 84
    constexpr auto GetAiManager = 0x289B30; // inner AiManager pointer resolver 73 20 90 0F B6 0C 02 láº¥y offset táº¡i Ä‘áº§u hÃ m sub_xxxxx
} // namespace NavGridRuntime
...
namespace RuneDataLayout {
    ...
    constexpr auto Id = 0x8; //41 8B 75 ? 48 8D 15 ? ? ? ? E8 ? ? ? ? 48 8B C8 48 8B F8 E8 ? ? ? ? 49 8D 4D
...
namespace RuneTreeDataLayout {
    ...
    constexpr auto Id = 0x0; //? ? ? E8 ? ? ? ? 48 8B C8 48 8B D8 E8 ? ? ? ? 49 8D 4E
...
namespace SpellBookLayout {
    constexpr auto Owner = 0x8; //49 C7 46 ? ? ? ? ? 49 8D 86
    ...
    namespace Hooks {
        constexpr uintptr_t OnIntegerPropertyChange = 0x38F590; //OnIntegerPropertyChange 48 8D 05 ? ? ? ? 89 7D ? 48 89 45 || 48 89 5C 24 ? 48 89 74 24 ? 57 48 83 EC ? 4C 8B 42 ? 48 8B DA
        ...
        constexpr uintptr_t ClientMainLoop          = 0x67C900; //E8 ? ? ? ? 48 8B 0D ? ? ? ? E8 ? ? ? ? 48 8B 0D ? ? ? ? E8 ? ? ? ? 48 8B 0D ? ? ? ? E8 ? ? ? ? 48 8B 0D ? ? ? ? E8 ? ? ? ? 48 8B 0D ? ? ? ? E8 ? ? ? ? E8
        constexpr uintptr_t CreateClientEffect      = 0x95BBB0; //E8 ? ? ? ? 45 33 C0 ? ? ? 48 8B 50 || E8 ? ? ? ? 48 8D 4D ? E8 ? ? ? ? 4C 8B E8

        constexpr uintptr_t DispatchEvent           = 0x49A2E0; //E8 ? ? ? ? E9 ? ? ? ? 4D 85 C0 || E8 ? ? ? ? 49 83 FE ? 76 ? 49 8D 56
        constexpr uintptr_t OnTeleport              = 0x731040; //OnTeleport E8 ? ? ? ? 48 83 C3 ? 48 3B DD 75 ? 48 8D 77 ? 48 8B CF
        constexpr uintptr_t Hud_OnDisconnect        = 0x6D4D30; //E8 ? ? ? ? 4C 8B B4 24 ? ? ? ? 48 8B 4D ? 48 33 CC E8 ? ? ? ? 48 81 C4 ? ? ? ? 5E
        ...
        constexpr uintptr_t OnCreate                = 0x57A1B0; //AssignNetworkId E8 ? ? ? ? 4C 8B 35 ? ? ? ? 8B 9E || E8 ? ? ? ? 48 8B 05 ? ? ? ? 39 78 ? 74
        constexpr uintptr_t OnMissileCreate         = 0x96D180; //E8 ? ? ? ? 48 8B 3D ? ? ? ? 33 C9 48 85 FF
        ...
        constexpr uintptr_t OnDelete                = 0x29CA90; //OnDelete 74 ? ? ? E8 ? ? ? ? 48 83 C3 ? 48 3B DF 75 ? 48 8B CE láº¥y offset táº¡i Ä‘áº§u hÃ m sub_xxxxx
        constexpr uintptr_t OnMissileDelete         = 0x951AF0; //E8 ? ? ? ? 48 8B 5C 24 ? 41 F6 C6
        constexpr uintptr_t OnDamage                = 0x2A8050; //48 8D 05 ? ? ? ? 44 89 75 ? 48 89 45 ? 48 8D 4C 24 ? 8B 44 24
        constexpr uintptr_t OnDoCast                = 0x999320; //48 8B 0D ? ? ? ? 48 8B 49 ? E8 ? ? ? ? 80 BF ? ? ? ? 00 0F 28 F8 75 láº¥y offset táº¡i Ä‘áº§u hÃ m sub_xxxxx
        constexpr uintptr_t OnFinishCast            = 0x2A8A40; //48 89 5C 24 ? 57 48 83 EC ? 48 8B F9 48 8B DA 8B 8A
        constexpr uintptr_t OnGameUpdate            = 0x572AC0; //OnUpdate E8 ? ? ? ? 41 0F B6 4E ? 49 8B 86
        constexpr uintptr_t OnLevelUp               = 0x29D6E0; //4C 89 BC 24 ? ? ? ? 8B FA láº¥y offset táº¡i Ä‘áº§u hÃ m sub_xxxxx
        // Packet callback for ids 0x11D/0x1F1. RCX is AIBaseClient and the
        // internal animation-name view is at RDX+0x18.
        constexpr uintptr_t OnPlayAnimation         = 0x2A2B60; //48 8B 4B ? E8 ? ? ? ? 4C 8D 44 24 láº¥y offset táº¡i Ä‘áº§u hÃ m
        constexpr uintptr_t OnProcessSpell          = 0x99D8D0; //OnProcessSpellCast E8 ? ? ? ? 85 C0 40 0F 94 C7 85 C0
        /*
        __int64 __fastcall sub_XXXXX(__int64 *a1, __int64 a2) //sub_XXXXX offset OnProcessSpell
{
  __int64 v3; // rcx
  __int64 v5; // rdi
  unsigned int v6; // ebx
  ...
  if ( *(_QWORD *)a2 )
  {
    v5 = sub_98ABC0(
           ...
           *(_BYTE *)(a2 + 330));
    v6 = (*(__int64 (__fastcall **)(__int64, __int64, char *))(*(_QWORD *)v5 + 8LL))(v5, a2, &v7);
    (**(void (__fastcall ***)(__int64, __int64))v5)(v5, 1);
    return v6;
  }
  else
  {
    sub_991D40(v3, *(unsigned int *)(a2 + 340));
    return 2;
  }
}
        */
        constexpr uintptr_t OnSpellImpact           = 0x9987F0; //E8 ? ? ? ? E9 ? ? ? ? 48 8B D3 48 89 B4 24 || E8 ? ? ? ? 83 BC 24 ? ? ? ? 00 48 8B B4 24
        constexpr uintptr_t OnStopCast              = 0x99DB80; //75 ? 8B 99 ? ? ? ? 8B 91 láº¥y offset táº¡i Ä‘áº§u hÃ m sub_xxxxx
        constexpr uintptr_t OnStealth               = 0x2A7720; //75 ? 44 8B 44 24 ? 49 8B C9 8B 54 24 ? E8 ? ? ? ? 48 8B 5C 24 láº¥y offset táº¡i Ä‘áº§u hÃ m sub_xxxxx
        constexpr uintptr_t OnSurrender             = 0; // FIXME: 0xE8D423 was wrong (string builder, not surrender handler). Needs re-verification.
        constexpr uintptr_t ProcessWorldEvent       = 0x6D5D90; //0F 87 ? ? ? ? 48 8D 35 ? ? ? ? 48 98 0F B6 84 06 ? ? ? ? 8B 8C 86 ? ? ? ? 48 03 CE FF E1 41 8B 46 láº¥y offset táº¡i Ä‘áº§u hÃ m sub_xxxxx
        ...
        constexpr uintptr_t OnNewPath               = 0x57A640; //E8 ? ? ? ? 49 8B 6E ? 48 63 C6
        //
    ...
    namespace SpellCastInfoLayout {
        constexpr auto SpellSlot     = 0x8;   // 48 89 48 ? 55 56 41 54 41 55 41 56 48 8D A8
        constexpr auto State         = 0xC;   // F0 0F C1 41 ? 83 F8 ? 75 ? ? ? ? FF 50 ? 48 85 DB 0F 84
    ...
    namespace ProcessCastSpellRequestLayout {
        ...
        constexpr auto DecodeTable = 0x1ABEC00; //4C 8D 05 ? ? ? ? 8B 05 ? ? ? ? 0F 57 C9 || 4C 8D 1D ? ? ? ? 49 3B D1 74 ? ? ? ? ? ? ? 2C
    } // namespace ProcessCastSpellRequestLayout
    ...
    namespace ItemRuntime {
        ...
        constexpr auto DataItemIdString   = 0x8; // legacy fallback only
    ...
    namespace AIHeroClient {
        ...
        constexpr auto PercentBonusArmorPen     = 0x22F0;
        ...
        constexpr auto VisionScore              = 0x5538;
        constexpr auto ShutdownValue            = 0x5560;
    ...
    namespace DirectInputRuntime {
        constexpr auto KeyboardInput     = 0x120C3D0;
        constexpr auto MouseInput        = 0x120C5E0;
        constexpr auto KeyboardDevice    = 0x1FA9C50;
        constexpr auto KeyboardBuffer    = 0x1FA9C60;
        constexpr auto KeyboardCount     = 0x1FA9C80;
        constexpr auto KeyboardFlag      = 0x1F47D58;
        constexpr auto MouseDevice       = 0x1FA9C58;
        constexpr auto MouseBuffer       = 0x1FA9C68;
        constexpr auto MouseCount        = 0x1FA9C90;
    ...
    namespace ZoomRuntime {
        ...
        constexpr auto ZoomEnableConfig = 0x1F6D980; //0F 95 05 ? ? ? ? E8 || 80 3D ? ? ? ? 00 8B 47
    } // namespace ZoomRuntime
    ...
    namespace SkinRuntime {
        ...
        constexpr auto CharacterDataStackUpdate = 0x214D90; //E8 ? ? ? ? 80 BD ? ? ? ? 00 74 ? 48 8B 8F || E8 ? ? ? ? 48 8B 8F ? ? ? ? ? ? ? 48 8B 5C 24
        constexpr auto CharacterDataStackPush   = 0x22FDB0; // Push(this=hero+0x40E0, model, skin, id, ...). 160-byte entries, calls Update after push. E8 ? ? ? ? 48 8D 8D ? ? ? ? E8 ? ? ? ? 48 85 C0 74 ? 48 85 ED
        constexpr auto CharacterDataStackBegin  = 0x0;
        constexpr auto CharacterDataStackEnd    = 0x8;
        constexpr auto CharacterDataStackCap    = 0x10;
        constexpr auto CharacterDataStackBaseSkin = 0x18;
        constexpr auto CharacterStackModelPtr   = 0x0;
        constexpr auto CharacterStackModelLen   = 0x8;
